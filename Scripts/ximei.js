...
if ($.isNode()) {
   if (process.env.XIMEI_URL && process.env.XIMEI_URL.indexOf('#') > -1) {
   ximeiurl = process.env.XIMEI_URL.split('#');
   console.log(`您选择的是用"#"隔开\n`)
  }
  else if (process.env.XIMEI_URL && process.env.XIMEI_URL.indexOf('\n') > -1) {
   ximeiurl = process.env.XIMEI_URL.split('\n');
   console.log(`您选择的是用换行隔开\n`)
  } else {
   ximeiurl = process.env.XIMEI_URL.split()
  };
  if (process.env.XIMEI_HD && process.env.XIMEI_HD.indexOf('#') > -1) {
   ximeihd = process.env.XIMEI_HD.split('#');
   console.log(`您选择的是用"#"隔开\n`)
  }
  else if (process.env.XIMEI_HD && process.env.XIMEI_HD.indexOf('\n') > -1) {
   ximeihd = process.env.XIMEI_HD.split('\n');
   console.log(`您选择的是用换行隔开\n`)
  } else {
   ximeihd = process.env.XIMEI_HD.split()
